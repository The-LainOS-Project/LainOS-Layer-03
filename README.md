...
> A systemd-free Gentoo-based Linux distribution built with OpenRC as PID 1, delivering compile-time hardening and native OpenRC service isolation (modeled on systemd hardening directives featured in Kicksecure/Whonix). Built upon the lainOS layer 02 foundation.
